...
static const struct ble_msg  apis[]={
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0,0x0,ble_cls_system,ble_cmd_system_usb_enumeration_status_get_id}, 0x0, (ble_cmd_handler)ble_default},
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0,0x0,ble_cls_system,ble_cmd_system_get_bootloader_crc_id}, 0x0, (ble_cmd_handler)ble_default},
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0,0x3,ble_cls_system,ble_cmd_system_delay_reset_id}, 0x42, (ble_cmd_handler)ble_default},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0,0x0,ble_cls_hardware,ble_cmd_hardware_get_timestamp_id}, 0x0, (ble_cmd_handler)ble_default},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0,0x0,ble_cls_dfu,ble_cmd_dfu_get_bootloader_crc_id}, 0x0, (ble_cmd_handler)ble_default},
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0,0x3,ble_cls_dfu,ble_cmd_dfu_delay_reset_id}, 0x42, (ble_cmd_handler)ble_default},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_rsp|0x0,0x3,ble_cls_system,ble_cmd_system_usb_enumeration_status_get_id}, 0x24, 	(ble_cmd_handler)ble_rsp_system_usb_enumeration_status_get},
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_rsp|0x0,0x2,ble_cls_system,ble_cmd_system_get_bootloader_crc_id}, 0x4, 	(ble_cmd_handler)ble_rsp_system_get_bootloader_crc},
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_rsp|0x0,0x0,ble_cls_system,ble_cmd_system_delay_reset_id}, 0x0, 	(ble_cmd_handler)ble_rsp_system_delay_reset},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_rsp|0x0,0x4,ble_cls_hardware,ble_cmd_hardware_get_timestamp_id}, 0x6, 	(ble_cmd_handler)ble_rsp_hardware_get_timestamp},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_rsp|0x0,0x2,ble_cls_dfu,ble_cmd_dfu_get_bootloader_crc_id}, 0x4, 	(ble_cmd_handler)ble_rsp_dfu_get_bootloader_crc},
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_rsp|0x0,0x0,ble_cls_dfu,ble_cmd_dfu_delay_reset_id}, 0x0, 	(ble_cmd_handler)ble_rsp_dfu_delay_reset},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_evt|0x0,0x1,ble_cls_system,ble_evt_system_usb_enumerated_id}, 0x2, 	(ble_cmd_handler)ble_evt_system_usb_enumerated},
...
void ble_send_message(uint16 msgid,...)            
    {
        ...
        va_end(va);
        if (bglib_output) {
            bglib_output(sizeof(struct ble_header) + apis[msgid].hdr.lolen,
                (uint8*)&packet,
                data_len,
                (uint8*)data_ptr);
        }
...
static const struct ble_msg* const ble_class_system_rsp_handlers[]=
{
	...
	&apis[ble_rsp_system_usb_enumeration_status_get_idx],
	&apis[ble_rsp_system_get_bootloader_crc_idx],
	&apis[ble_rsp_system_delay_reset_idx],
};
static const struct ble_msg* const ble_class_system_evt_handlers[]=
{
	...
	&apis[ble_evt_system_usb_enumerated_idx],
};
...
static const struct ble_msg* const ble_class_hardware_rsp_handlers[]=
{
	...
	&apis[ble_rsp_hardware_get_timestamp_idx],
};
...
static const struct ble_msg* const ble_class_dfu_rsp_handlers[]=
{
	...
	&apis[ble_rsp_dfu_get_bootloader_crc_idx],
	&apis[ble_rsp_dfu_delay_reset_idx],
};
...
{
	{ble_class_system_rsp_handlers,21},
