...
void ble_evt_system_usb_enumerated(const struct ble_msg_system_usb_enumerated_evt_t*msg)
{

}

void ble_rsp_system_usb_enumeration_status_get(const struct ble_msg_system_usb_enumeration_status_get_rsp_t *msg)
{
...
void ble_rsp_hardware_get_timestamp(const struct ble_msg_hardware_get_timestamp_rsp_t *msg)
{
}
...
{}
/**Get bootloader CRC16 value, works the same as ble_rsp_system_get_bootloader_crc**/
void ble_rsp_dfu_get_bootloader_crc(const struct ble_msg_dfu_get_bootloader_crc_rsp_t *msg)
{}
/**Delay and reset system, works the same as ble_rsp_system_delay_reset**/
void ble_rsp_dfu_delay_reset(const void *nul)
{}
/**Get bootloader CRC16 value**/
void ble_rsp_system_get_bootloader_crc(const struct ble_msg_system_get_bootloader_crc_rsp_t *msg)
{}
/**Delay and reset system**/
